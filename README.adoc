...
== このリポジトリについて
OpenShift Virtualization Roadshow (2026)コンテンツの日本語訳＋カスタム版のリポジトリです。

英語版オリジナルのリポジトリは下記です。

https://github.com/rhpds/ocp-virt-roadshow-2026-showroom
...
----
curl -sSL https://raw.githubusercontent.com/loungeplus/virt-basic/refs/heads/main/translation.sh | bash
----
